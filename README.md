...
## Referencess
- [Rouard, S., Massa, F., & Défossez, A. (2023). Hybrid Transformers for Music Source Separation. In *Proceedings of ICASSP 23*. ](https://github.com/facebookresearch/demucs)
...
- [Panns: Large-scale pretrained audio neural networks for audio pattern recognition.](https://github.com/qiuqiangkong/audioset_tagging_cnn) Qiuqiang Kong, Yin Cao, Turab Iqbal, Yuxuan Wang, Wenwu Wang, and Mark D. Plumbley. IEEE/ACM Transactions on Audio, Speech, and Language Processing 28 (2020): 2880-2894.